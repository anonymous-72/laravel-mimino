<footer class="border-t border-red bg-[#101010] p-6 md:p-12 lg:p-18">
    <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pb-6 md:pb-12 lg:pb-18 border-b border-gray-400">
        ...
        <ul class="flex flex-col gap-6">
            ...
            <li class="flex gap-2 items-center">
                ...
                <a href="https://www.instagram.com/miminomd/" class="flex gap-1 items-center link text-base md:text-lg lg:text-xl font-medium">
            ...
            <li class="flex gap-3 items-center">
                ...
                <a href="https://www.facebook.com/mimino.moldova" class="flex gap-1 items-center link text-base md:text-lg lg:text-xl font-medium">
    ...
    <div class="flex items-center justify-center gap-2 text-sm md:text-base lg:text-lg font-semibold pt-3 md:pt-6 lg:pt-9">
        ...
        <div class="flex items-center gap-2">
            <a href="https://github.com/anonymous-72"><img src="{{ asset('/icons/github.svg') }}" alt="GitHub" class="w-5 h-5"></a>
            <a href="https://www.linkedin.com/in/serghei-bordeniuc-557291271/"><img src="{{ asset('/icons/linkedin.svg') }}" alt="LinkedIn" class="w-5 h-5"></a>
        </div>
    </div>
</footer>
